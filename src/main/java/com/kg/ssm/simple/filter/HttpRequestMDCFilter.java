package com.kg.ssm.simple.filter;

import com.kg.ssm.simple.constant.MDCConstants;
...
public class HttpRequestMDCFilter implements Filter {
    ...
    private String getLocalIp() {
        try {
            ...
            log.error("HttpRequestMDCFilter getLocalIp happen error:", e);
        }
        return null;
    }
    ...
    public void doFilter(ServletRequest request, ServletResponse response, FilterChain chain) throws IOException, ServletException {
        ...
        try {
            ...
            log.error("HttpRequestMDCFilter mdc happen error:", e);
        }
